...
import WorkspacePlaceholder from "./workspace-placeholer";
...
const Sidebar = ({ activeWorkspaceId }: SidebarProps) => {
  ...
  const SidebarSection = (
    /* TODOS: fix scroll area */
    <ScrollArea className="bg-[#111111] flex-none relative p-4 h-full w-[250px]  items-center overflow-hidden">
