...
/* TODO: upload video button style is wrong, re watch the video and change it */
/* TODO: add functionality to all components (do what every title says - challenge) */
/* NOTE: suppose record button is recording on browser-side (the main recording was already handled in electron) */
/* NOTE: upload button is for uploading files to the workspace/ redirect to upload page */
